...
public class CompoundDistillationFractionator extends WirelessEnergyMultiMachineBase<CompoundDistillationFractionator> {
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("gtnl.machine.compound_distillation_fractionator.recipe_type"))
            ...
            .addInputBus(
                "0+",
                StatCollector.translateToLocal("gtnl.machine.compound_distillation_fractionator.casing"),
                1)
            .addOutputBus(
                "0+",
                StatCollector.translateToLocal("gtnl.machine.compound_distillation_fractionator.casing"),
    ...
    public String getMachineModeKey() {
        return "gtnl.machine.compound_distillation_fractionator.mode." + machineMode;
    }
