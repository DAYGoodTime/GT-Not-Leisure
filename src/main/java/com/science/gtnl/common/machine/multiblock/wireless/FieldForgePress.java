...
public class FieldForgePress extends WirelessEnergyMultiMachineBase<FieldForgePress> {
    ...
    public void checkMachine(IGregTechTileEntity aBaseMetaTileEntity, ItemStack aStack, List<StructureError> errors) {
        ...
        setupParameters();
        checkHatch(errors);
        checkCasingMin(errors, mCountCasing, 1801);
    }
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("gtnl.machine.field_forge_press.recipe_type"))
            ...
            .addInputBus("0+", StatCollector.translateToLocal("gtnl.machine.field_forge_press.casing"), 1)
            .addOutputBus("0+", StatCollector.translateToLocal("gtnl.machine.field_forge_press.casing"), 1)
            .addInputHatch("0+", StatCollector.translateToLocal("gtnl.machine.field_forge_press.casing"), 1)
            .addOutputHatch("0+", StatCollector.translateToLocal("gtnl.machine.field_forge_press.casing"), 1)
            .addEnergyHatch("0+", StatCollector.translateToLocal("gtnl.machine.field_forge_press.casing"), 1)
            .toolTipFinisher();
        return tt;
    }
