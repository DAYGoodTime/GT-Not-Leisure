...
public class MegaWiremill extends WirelessEnergyMultiMachineBase<MegaWiremill> {
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("gtnl.machine.mega_wiremill.recipe_type"))
            .addInfo(StatCollector.translateToLocal("gtnl.machine.mega_wiremill.info"))
            ...
            .addInputBus("0+", StatCollector.translateToLocal("gtnl.machine.mega_wiremill.casing"), 1)
            .addOutputBus("0+", StatCollector.translateToLocal("gtnl.machine.mega_wiremill.casing"), 1)
            .addInputHatch("0+", StatCollector.translateToLocal("gtnl.machine.mega_wiremill.casing"), 1)
            .addOutputHatch("0+", StatCollector.translateToLocal("gtnl.machine.mega_wiremill.casing"), 1)
            .addEnergyHatch("0+", StatCollector.translateToLocal("gtnl.machine.mega_wiremill.casing"), 1)
