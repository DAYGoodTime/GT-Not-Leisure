    ...
    public void loadRecipes() {
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "ABC", "DBA", "EFE", 'A', GTNLItemList.HydraulicConveyor.get(1), 'B',
                ItemList.ReinforcedGlass.get(1L), 'C', GTNLMaterials.Breel.get(OrePrefixes.pipeTiny, 1), 'D',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { " A ", " B ", "   ", 'A',
                GTOreDictUnificator.get(OrePrefixes.pipeNonuple, Materials.SpaceTime, 1L), 'B',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "ABA", "CDC", "EBF", 'A',
                ...
                ItemList.ReinforcedGlass.get(1L), 'D',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "ABA", "CDC", "EFE", 'A', ItemList.ReinforcedGlass.get(1L), 'B',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "AAA", "BCB", "DBD", 'A', GTOreDictUnificator.get(OrePrefixes.plate, Materials.CastIron, 1L),
                'B', GTOreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 1L), 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "ABA", "BCB", "DDD", 'A', ItemList.ReinforcedGlass.get(1L), 'B',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "ABA", "ACA", "DED", 'A', ItemList.ReinforcedGlass.get(1L), 'B',
                GTOreDictUnificator.get(OrePrefixes.rotor, Materials.Steel, 1L), 'C',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "AAA", "BCB", "AAA", 'A',
                GTOreDictUnificator.get(OrePrefixes.plate, Materials.ClayCompound, 1), 'B',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "AAA", "wBh", "AAA", 'A',
                GTOreDictUnificator.get(OrePrefixes.stick, Materials.ClayCompound, 1), 'B',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "ABA", "CDE", "ABA", 'A', ItemList.Casing_BronzePlatedBricks.get(1), 'B',
                ...
                GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.ClayCompound, 1), 'E',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "AAA", "BCC", "DEF", 'A',
                GTOreDictUnificator.get(OrePrefixes.plate, Materials.ClayCompound, 1), 'D',
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "AAA", "BCB", "DEC", 'A',
                ...
                GTOreDictUnificator.get(OrePrefixes.gear, Materials.ClayCompound, 1) });
        ...
        GTModHandler.addCraftingRecipe(
            ...
            new Object[] { "ABA", "ACA", "ADA", 'A', GTOreDictUnificator.get(OrePrefixes.plate, Materials.CastIron, 1),
                'B', ToolDictNames.craftingToolWrench, 'C',
                GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Steel, 1), 'D',
                ToolDictNames.craftingToolHardHammer });
